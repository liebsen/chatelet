        ...
        <section id="desarrollo">
            <div class="wrapper">
                <div class="col-sm-6">
                    ...
                    <p>Todos los envíos son efectuados por OCA y podes seguir el estado del mismo ingresando en <a class="text-info" href="https://www.oca.com.ar/Busquedas/Envios" target="_blank">la página de búsqueda de envíos de OCA</a></p>
                </div>
