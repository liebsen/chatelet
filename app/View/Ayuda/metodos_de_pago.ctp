                ...
                <div class="col-xs-12 col-md-6">
                    <div class="is-flex-center flex-column gap-1 ">
                        ...
                        <ul>
                            ...
                            <!--li>***El pago se acredita en el momento por lo que tu pedido será despachado en 24 hs. En todos los casos CHÂTELET te mantendrá informado sobre el estado del pedido y el tiempo de acreditación del pago dependerá del sistema que seleccione el cliente.</li>
