...
?>
        ...
        <section id="desarrollo">
            <div class="wrapper  animated fadeIn delay2 text-center"> 
            ...
            <div class="wrapper">
                <div class="col-xs-12 col-sm-6">
                    ...
                    <ul>
                        ...
                        <li class="mb-2">** Transferencia bancaria: Al finalizar el pedido en pantalla te aparecerán los datos bancarios e importe final para que puedas transferir. Recordá siempre enviarnos el comprobante por WhatsApp al 11-5504-2428</li>
