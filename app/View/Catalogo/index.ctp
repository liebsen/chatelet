                          ...
                          $url = $this->Html->url(array(
                            ...
                            data-img="<?=$img?>">
                              ...
                              <img id="img_padding" style="cursor:pointer;" onclick="javascript:window.location.href='<?php echo $url  ?>';"
                               src="<?php echo $settings['upload_url'].$value['LookBook']['img_url'] ?>" >
                 ...
                 <?php foreach ($product as $k => $v) : ?>
                    <?php if (!empty($v)): ?>
                      ...
                      <li class="lc" style="border-bottom: 2px solid #c2c2c2;margin-bottom: 45px;padding-bottom: 45px;">
                        <div class="row">
                          <div class="col-sm-3">
                            <img class="img-responsive" src="<?php echo $settings['upload_url'].$v['Product']['img_url'] ?>" >
                          </div>
                          <div class="col-sm-9">
...
<div class="modal fade" tabindex="-1" id="myModal2" role="dialog">
  ...
  <?php if (!empty($talle_img)): ?>
    <div align="center" class="centered">
        <img style="max-width:100%;" src="<?=$settings['upload_url']?><?=$talle_img?>" border="0" />
    </div>
  <?php else: ?>
        <div class="table">
