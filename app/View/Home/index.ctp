...
?>
    ...
    ?>        
        <div class="modal fade" tabindex="-1" id="myModal" role="dialog">
            ...
            <?php else:?>
            <div class="content" style="<?=(!empty($home['img_popup_newsletter']))?'background: url('.Configure::read('imageUrlBase').$popupBG[0].');background-repeat-y: no-repeat;':'background: url(images/livebox-bg.jpg);'?><?=(isset($popupBgWidth))?'width:'.$popupBgWidth.'px;':''?>">
                <a class="close" data-dismiss="modal">
                    <span></span>
                    <span></span>
                </a>
