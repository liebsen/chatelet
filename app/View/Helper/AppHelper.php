  ...
  function parse_legend_texts($legends, $item){
    ...
    if($item['mp_discount'] || $item['bank_discount']) {
      ...
      if($item['mp_discount']){
        ...
        $str.= "<span class='badge badge-light' title='{$amount} abonando con mercadopago'><i class='fa fa-credit-card'></i> -". $item['mp_discount'] ."%</span>";
      }
      ...
      if($item['bank_discount']){
        ...
        $str.= "<span class='badge badge-light' title='{$amount} abonando con transferencia'><i class='fa fa-bank'></i> -". $item['mp_discount'] ."%</span>";
      }
      $str.= "</div>";
    }
