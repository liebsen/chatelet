	  ...
	  <div class="col-md-6">
	    ...
	    <div class="control-group">
	      ...
	      <div class="controls position-relative">
	        <input type="password" maxlength="100" name="data[mercadopago_client_secret]" id="client_secret" class="form-control" value="<?php echo @$settings['mercadopago_client_secret'] ?>" placeholder="Codigo secret"/>
	        <i class="form-pass-icon fa fa-eye-slash is-clickable" data-target="#client_secret"></i>
	      </div>
	    </div>
	  </div>
	  <div class="col-md-6">
	...
	<p>
		<a href="https://developers.mercadopago.com" target="_blank">
			...
			<span class="ml-1">Más sobre Mercado Pago</span>
		</a>
	</p>						  