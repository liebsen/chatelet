              ...
              <span class="category-item-image" style="background-image: url('<?php echo $settings['upload_url'].$category['Category']['img_url']?>')">
                <span class="category-image ci-<?= !empty($category['Category']['alignnum']) ? $category['Category']['alignnum'] : '0' ?> p-3 w-100">  
                  ...
                  <span class="category-toolbox">
                    <div class="control-group d-flex justify-content-center align-items-center gap-05">
                      <div class="controls">
                      ...
                      <div class="controls">
                        <select class="form-control update-colsize" name="data[colsize]" title="Ancho de columna">
