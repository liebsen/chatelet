    ...
    <div class="col-md-6 <?=!empty($list['NewsletterList']['id'])?'':' d-disable'?>">
      ...
      <div class="form-box bg-info-outline">
        ...
        <div class="secondary-box">
          <a class="btn btn-sm btn-success relations-action-add is-clickable d-none" data-type="user" data-parent-id="<?=$list['NewsletterList']['id']?>" href="javascript:void(0)">Agregar <span class="relations-count"><?=count($list_users)?></span></a>
          <?php if(count($list_users)): ?>
          <a class="btn btn-sm btn-danger relations-action-remove is-clickable" data-type="user" data-model="NewsletterUser" data-source="list" data-key="all" data-parent-id="<?=$list['NewsletterList']['id']?>" href="javascript:void(0)">Eliminar todo</a>
          <?php endif ?>
          <a class="btn btn-sm btn-success relations-action-add relations-add-all is-clickable" data-type="user" data-model="NewsletterUser" data-source="list" data-key="all" data-parent-id="<?= $list['NewsletterList']['id'] ?>">Seleccionar todos (<?=$users_total?>)</a>          
        </div>
