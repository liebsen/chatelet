    ...
    <div class="col-md-6">
      ...
      <div class="form-group flex-end flex-between gap-05">
        <div class="controls flex-1">
          ...
          <input type="checkbox" name="data[enabled]" value="1" id="toggle" class="toggle-checkbox"<?=@$list['NewsletterList']['enabled'] == '1' ? ' checked' : (!empty($list['NewsletterList']['id']) ? '' : ' checked')?>>
    ...
    <div class="col-md-6 enable-on-save <?=!empty($list['NewsletterList']['id'])?'':' d-disable'?>">
      ...
      <div class="form-box bg-info-outline">
        ...
        <div class="secondary-box">
          <a class="relations-action-add text-success is-clickable d-none" data-type="user" data-parent-id="<?=$list['NewsletterList']['id']?>" href="javascript:void(0)">Agregar <span class="relations-count"><?=count($list_users)?></span></a>
