  ...
  <body class="noscroll p-0">
    <?php if($settings['env_staging']) : ?>
      <div class="dev-note is-flex-center p-3 text-center bg-warning animation-pullUp animation-both delay10">
        ...
        <span class="text-sm text-dark"><b><i class="gi gi-warning_sign text-danger mr-1"></i> Tienda de pruebas&nbsp;<a class="text-info text-bold" href="https://chatelet.com.ar">Ir a tienda oficial Châtelet</a></span>
      </div>
      <style>
        .dev-note {
          position: fixed;
