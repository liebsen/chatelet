  ...
  <body class="noscroll p-0">
    <?php if($settings['env_staging']) : ?>
      <div class="dev-note is-flex-center p-3 text-center bg-danger animation-pullUp animation-both delay10">
        ...
        <span class="text-sm text-dark">Esta <b>no es la tienda oficial</b> de <b>Châtelet</b> &nbsp;<a class="text-info text-bold" href="https://chatelet.com.ar">Ir a tienda oficial</a></span>
      </div>
      <style>
        .dev-note {
          position: fixed;
