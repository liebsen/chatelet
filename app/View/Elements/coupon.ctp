...
?>
 	<div class="calc-coupon' d-flex flex-column justify-content-center align-items-start">
    		...
    		<button id="btn-calculate-coupon" class="btn btn-calculate-coupon btn-chatelet" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i>" title="Aplicá este cupón a tu compra" type="button" onclick="submitCoupon()">Aplicar</button>
		</div>
	</div>