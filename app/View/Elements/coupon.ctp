...
?>
 	<div class="calc-coupon' d-flex flex-column justify-content-center align-items-start">
 			...
 			<div class="d-flex justify-content-center align-items-center gap-05 w-100">
 				<div class="input-status input-coupon-status position-relative flex-1">
 		  		<input type="text" id="coupon_name" name="coupon" placeholder="Código de cupón" value="" class="form-control both input-coupon" title="Ingresá el código de tu cupón" data-valid="0" autocomplete="off" />
 		  	</div>
