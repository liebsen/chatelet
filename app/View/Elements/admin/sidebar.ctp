...
<aside id="toggle-sidebar" class="collapse navbar-collapse hide-print navbar-main-collapse <?php if ($template['sidebar'] == 'sticky') { echo ' sticky'; } ?> in">
    <!--
        ...
        <div class="sidebar-tabs-con">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="side-tab-menu">
                    <!-- Primary Navigation -->
                    <nav id="primary-nav">
                        <div class="form-group primary-search">
