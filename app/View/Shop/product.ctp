		...
		function createSection($item, $ctrl, $isProduct = false) {
         ...
         '</span>';
			...
			if ($isProduct) {
				...
				$discount_flag = 	(@$_GET['testing']=='1' && @$item['category_id']!='128' || @$item['category_id']!='128' && (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105)?'<div class="discount-flag">20% OFF</div>':'';
