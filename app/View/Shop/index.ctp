...
<div id="headshop">
  ...
  <div class="img-resp" style="background-image:url(<?php echo $settings['upload-url'].@$data['image_bannershop'] ?>)"></div>
</div>
    ...
    <div class="row m-0">
      <div class="col-xs-12">
        <div class="row">
          ...
          <div class="category-item p-0 col-xs-12 col-md-<?= !empty($category['Category']['colsize']) ? $category['Category']['colsize'] : 'auto' ?>" style="background-image: url('<?php echo $settings['upload-url'].$category['Category']['img_url']?>')">
