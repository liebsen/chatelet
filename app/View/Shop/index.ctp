        ...
        <section id="listShop">
                ...
                <div class="row">
                     <div class="col-xs-12">
                        <div class="row">
                                ...
                                <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[0]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
                                </div>
                                <?php } ?>
                                ...
                                <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[1]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
                                </div>
                                <?php } ?>
                                ...
                                <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[2]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
                                </div>
                                <?php } ?>
                                ...
                                <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[3]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
                                </div>
                                <?php } ?>
                                ...
                                <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[4]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
                                </div>
                                <?php } ?>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-4">
                                    ...
                                    <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[11]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
                                  </div>
                                <?php } ?>
                                 ...
                                 <div class="col-xs-12 col-sm-6 col-md-4">
                                    ...
                                    <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[10]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
                                    </div>
                                <?php } ?>
                                ...
                                <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[5]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
                                </div>
                                <?php } ?>
                                ...
                                <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[6]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
                                </div>
                                <?php } ?>
                                 ...
                                 <div class="col-xs-12 col-sm-6 col-md-4">
                                    ...
                                    <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[12]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
                                    </div>
                                <?php } ?>
                                ...
                                <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[8]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
                                </div>
                                <?php } ?>
                                ...
                                <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[7]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
                                </div>
                                <?php } ?>
                                ...
                                <?php if(!empty($categories[13])){ ?>
                                    ...
                                    <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[13]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
                                    </div>
                                <?php } ?>
                                ...
                                <?php if(!empty($categories[9])){ ?>
                                    ...
                                    <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[9]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
                                    </div>
                                <?php } ?>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4"><a href="<?php echo $this->Html->url(array('controller' => 'tienda', 'action' => 'productos', str_replace(array('ñ',' '),array('n','-'),strtolower($categories[14]['Category']['name'])))); ?>" class="pd2">
                                ...
                                <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[14]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
															</div>
			...
			<?php if(!empty($categories[16])){ ?>
                            <div class="col-xs-12 col-sm-6 col-md-4"><a href="<?php echo $this->Html->url(array('controller' => 'tienda', 'action' => 'productos', str_replace(array('  ',' '),array('n','-'),
                                ...
                                <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[16]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
															</div>
				...
				strtolower($categories[15]['Category']['name'])))); ?>" class="pd2">
                                ...
                                <?php if (@$_GET['testing']=='1' || (int)gmdate('Ym')>201910 && (int)gmdate('Ymd')<20191105 && strtolower($categories[15]['Category']['name'])!='liquidacion'){ echo '<div class="discount-flag">20% OFF</div>'; } ?></a>
															</div>
