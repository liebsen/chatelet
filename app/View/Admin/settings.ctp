		        		...
		        		<div class="col-md-12">
					      ...
					      <?php foreach($items as $item): ?>
					        <div class="control-group d-flex flex-column">
										...
										<?php if(substr($item['Setting']['id'], -4) == '_on') :?>
											<div class="controls flex-1 mt-1">
												<input type="checkbox" id="toggle_<?php echo $item['Setting']['id'] ?>" name="data[<?php echo $item['Setting']['id'] ?>]" value="1" id="toggle" class="toggle-checkbox"<?= $settings['mc_'.$item.'_on'] == '1' ? ' checked' : '' ?>>
