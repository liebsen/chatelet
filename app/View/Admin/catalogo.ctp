      ...
      <div class="row">
        <div class="col-md-5">
          <div class="gallery" data-toggle="lightbox-gallery">
            ...
            ?>
              <div class="col-md-5 gallery-image">
                <img src="<?php echo $settings['upload_url'] . $image; ?>" alt="image">
                <div class="gallery-image-options">
                  <a href="<?php echo $settings['upload_url'] . $image; ?>" class="gallery-link badge badge-info">
        ...
        <div class="control-group">
            ...
            <div class="controls">
              <script id="image_thumb" type="text/x-handlebars-template" data-url="<?php $settings['upload_url'] ?>">
