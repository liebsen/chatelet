...
<div class="block">
	<div class="block-content">
		<form action="" method="post" class="form-inline" enctype="multipart/form-data">
	      ...
	      <div class="col-md-6">
	        ...
	        <div class="control-group">
	          ...
	          <div class="controls text-center switch-scale">
	            <?php
	              $enabled = $settings['whatsapp_enabled'] == 1 ? 'checked' : '';
	              $disabled = $settings['whatsapp_enabled'] == 0 ? 'checked' : '';
	            ?>
	            <span>
	      ...
	      <div class="col-md-6">
	      	<div class="show-panel <?= !$settings['whatsapp_enabled'] ? 'show-inactive' : '' ?>">
		        ...
		        <div class="control-group">
		          ...
		          <div class="controls">
		            <textarea name="data[whatsapp_text]" class="form-control w-100"><?= @$settings['whatsapp_text'] ?></textarea>
		          </div>
		        </div>
		        <div class="control-group">
		          <label class="control-label" for="columns-text"><?php echo __('Autoesconder (segs)'); ?></label>
		          <div class="controls">
		            <input type="number" max="100" min="0" size="4" name="data[whatsapp_autohide]" class="form-control" value="<?= @$settings['whatsapp_autohide'] ?>"/>
		          </div>
		        ...
		        <div class="control-group">
		          ...
		          <div class="controls">
		            <input type="number" min="0" size="16" name="data[whatsapp_phone]" class="form-control" value="<?= @$settings['whatsapp_phone'] ?>"/>
		          </div>
		        ...
		        <div class="control-group">
		          ...
		          <div class="controls text-center switch-scale">
		            <?php
		              $enabled = $settings['whatsapp_animated'] == 1 ? 'checked' : '';
		              $disabled = $settings['whatsapp_animated'] == 0 ? 'checked' : '';
		            ?>
		            <span>
